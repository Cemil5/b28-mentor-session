...
import week_02_e_commerce.company.category.Category;
import week_02_e_commerce.company.discount.Discount;
import week_02_e_commerce.company.order.Order;
import week_02_e_commerce.company.order.OrderService;
import week_02_e_commerce.company.order.OrderServiceImpl;
        ...
        while(true){
            ...
            switch (menuSelection){
                ...
                case 4:
                    ...
                    break;
                case 5:
                    if (cart.getProductMap() == null) {         // added later
                    ...
                    if (cart.calculateCartTotalAmount() >= 250) {     // added after live session
                        ...
                        for (Discount discount : DISCOUNT_LIST) {
                            ...
                            + "discount threshold: " + discount.getThresholdAmount());    // added after live session
                        }
